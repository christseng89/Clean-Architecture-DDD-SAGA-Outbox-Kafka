...
public class OrderCreateHelper {
  ...
  @Transactional
  public OrderPendingEvent persistOrderEvent(CreateOrderRequest createOrderRequest) {
    ...
    OrderPendingEvent orderPendingEvent = orderDomainService.validateAndInitiateOrder(order, restaurant);
