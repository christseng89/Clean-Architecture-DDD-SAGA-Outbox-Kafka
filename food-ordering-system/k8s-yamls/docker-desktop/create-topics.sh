...
kafka-topics --zookeeper $1:2181 --topic restaurant-status-request --delete --if-exists
kafka-topics --zookeeper $1:2181 --topic restaurant-status-response --delete --if-exists
...
kafka-topics --zookeeper $1:2181 --topic restaurant-status-request --create --partitions 3 --replication-factor 3 --if-not-exists
kafka-topics --zookeeper $1:2181 --topic restaurant-status-response --create --partitions 3 --replication-factor 3 --if-not-exists
